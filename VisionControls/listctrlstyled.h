...
#ifndef INCLUDE_LISTCTRLSTYLED
#define INCLUDE_LISTCTRLSTYLED __declspec(dllimport)
#endif //INCLUDE_LISTCTRLSTYLED

// ---------------------
// -- CListCtrlStyled --
// ---------------------
class INCLUDE_LISTCTRLSTYLED CListCtrlStyled : public CListCtrl
{
public:
	// -- Construction --
	//
	...
	COLORREF GetRowBgColor(int nRow);
